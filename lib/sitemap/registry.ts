...
export const CORE_PAGES: SitemapUrl[] = [
  ...
  u('/services/answer-and-book/', 'monthly', 0.8),
  u('/services/local-seo-maps/', 'monthly', 0.8),
  u('/services/paid-acquisition/', 'monthly', 0.8),
  u('/services/conversion-cro/', 'monthly', 0.8),
  u('/services/recover-reactivate/', 'monthly', 0.8),
  u('/services/reviews-reputation/', 'monthly', 0.8),
  u('/contact-me/', 'yearly', 0.7),
  u('/about/', 'yearly', 0.6),
  u('/industries/', 'monthly', 0.7),
  u('/industries/industrial-distribution/', 'monthly', 0.8),
  u('/industries/home-services/', 'monthly', 0.8),
  u('/industries/medical-aesthetics/', 'monthly', 0.8),
  u('/industries/consumer-brands/', 'monthly', 0.8),
