 ...
 * /industries/medical-aesthetics/), so it never reached the served sitemap. This test
...
test('the previously-dropped routes are registered', () => {
  ...
  assert.ok(
    registeredPaths.has('/industries/medical-aesthetics/'),
    '/industries/medical-aesthetics/ must be registered',
  )
})
