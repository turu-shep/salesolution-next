...
- **Open before publish:** (1) **AIOverviewMockup landmine** — the `Forge Fluid Power` / `Cedar & Co Roofing` / etc. fabricated placeholders (homepage hero + industrial pillar) must become real consenting clients or stay noindex; fix per [case-studies/fact-ledger.md](../case-studies/fact-ledger.md). (2) industrial pillar's stale "Six cylinders" copy + dim BRING/CONVERT/RETAIN eyebrows. (3) consumer card image still warm-graded — re-grade to blue. (4) a styled "Featured engines" nav divider + the Jewelry niche await Phase 6.
