...
| Trade content foundation (~10–15 cost guides / service pages; growth on retainer) | No — D-HS1 | $3,000–$8,000 one-time ($250–400/article) | SEARCH (Elorites/Clutch roundups 2025) |
| Google Ads + LSA foundation (their account, tracking, first campaigns, creatives) | Partial (O2 carries campaigns today) — D-HS1 | $500–$1,500 setup + $650–2,650/mo à la carte mgmt | OPENED (mgmt band, Hook) / SEARCH (LSA $149/mo, Footbridge) |
| Retention/reactivation engine (email+SMS, quote-chase) | **Yes** | $2,000–$5,000 setup + $500–3,000/mo | SEARCH (Enflow/Sender 2025) |
| Review/reputation program (FTC-compliant velocity) | **Yes** | $299–$1,000/mo platform tiers (quote-gated vendors — treat as floors) | SEARCH (Podium/Birdeye analyses) |
| Call answering/tracking + two-lines dashboard | **Yes** | ~$300–$1,900/mo assembled (tracking $45–195 + answering $250–1,725 held) | SEARCH (CallRail tiers) + held |
