...
export const LEAK_DATA: Record<Vertical, LeakData> = {
    ...
    evidence: {
      cards: [
        ...
        },
        {
          ...
          kicker: 'Convert · They reach you, then slip through',
  ...
  medical: {
    ...
    evidence: {
      cards: [
        {
          chrome: 'Google · "near me"',
          rows: [
            { left: '1.  Lakeside Clinic', right: '4.9 ★' },
            { left: '2.  Park Aesthetics', right: '4.8 ★' },
            { left: '3.  Cedar Dental', right: '4.8 ★' },
            { left: '5.  You', right: 'below the fold', flag: true },
          ],
          annotation: 'where patients pick from',
          kicker: 'Bring · They never find you',
          label: "You're not in the local pack",
          body: 'New patients pick from the top three Maps results when they search a procedure nearby. You are below the fold.',
          source: 'Backlinko, local search study',
        },
        {
          chrome: 'iPhone · Recents',
          ...
          kicker: 'Convert · They call during treatment',
        ...
        },
        {
          ...
          rows: [
            { left: '$5,400 plan', right: 'Presented · no follow-up · 19 days', flag: true },
            { left: 'Recall · 14 mo', right: 'No reminder sent', flag: true },
          ],
          kicker: 'Retain · The plan presented once',
          label: 'High-value plans that went quiet',
          body: 'The plan was presented, the patient said they would think about it, and no one circled back. Overdue recall slips the same way.',
        },
      ],
      note: 'Reconstructed from real audits. Names and numbers changed.',
    },
      ...
      cards: [
        {
          ...
          kicker: 'Bring · Not in the top three',
        ...
        },
        {
          ...
          kicker: 'Convert · The shoppers who looked and left',
        ...
        },
        {
          ...
          kicker: 'Retain · The customers you already won',
