    ...
    <SectionRail tone="dark" size="lg">
      <div className="max-w-3xl">
        <h2 className="font-display text-balance text-4xl font-semibold leading-[1.05] tracking-[-0.015em] text-white sm:text-6xl">
          See where you&rsquo;re losing customers.
        </h2>
        <p className="mt-6 max-w-xl text-lg leading-relaxed text-ink-300">
          Two doors, depending on your business. Either way you leave with the
          numbers &mdash; the exact gap and the highest-payback fix &mdash;
      ...
      <div className="mt-10 grid max-w-3xl gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <div className="flex flex-1 flex-col p-6">
            ...
            <span className="mt-2 text-sm leading-relaxed text-ink-300">
