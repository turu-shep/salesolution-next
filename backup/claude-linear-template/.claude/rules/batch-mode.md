...
- "Implement PROJ-73, PROJ-71, and PROJ-74 in parallel worktrees. Create branches, implement, commit, push, and open PRs."
- "Let's knock out PROJ-19, PROJ-75, and PROJ-77"
- "Ship PROJ-73 PROJ-71 PROJ-74"
- "Do all the In Progress issues assigned to me"
- "Run PROJ-73 and PROJ-74 in pair mode"

Examples that should NOT route to batch mode:
- "Look at PROJ-73 and PROJ-74" (exploration, not execution)
- "Compare PROJ-73 and PROJ-74" (analysis)
- "What's the status of PROJ-73 and PROJ-74?" (query — use `/sync`)
- "Implement PROJ-73" (single issue — use `/pull-task` + `/implement`)
